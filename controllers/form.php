...
if (isset($_POST["submit"])) {
	...
	// Fill all the fields.	
	if (!isset($_POST['workerID']) || empty($_POST['workerID']) || !isset($_POST['gender']) || empty($_POST['gender']) || !isset($_POST['age']) || empty($_POST['age']) || !isset($_POST['consent']) || empty($_POST['consent'])) {
		$message["text"] = "All the fields must be filled";
	...
	if ($gender != 'female'  &&  $gender != 'male' ) {
	 ...
	 $query    = "INSERT INTO `users`(`worker_id`, `age`, `gender`, `creation_time`,
	 `modification_time`, `active`,`data`) VALUES
	 ('$workerId','$age','$gender',now(),null,1,'')";
