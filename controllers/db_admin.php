...
// output the column headings
fputcsv($output, array('experiment','sub_experiment_name','field','result','userId','workerId','age','gender','start_time', 'end_time'));
...
users.creation_time AS start_time,
users.modification_time AS end_time
...
WHERE experiments.id=2 and sub_experiments.id=3 and users.id in (SELECT users.id from users)
;
";
